...
-- points of view: 0-none 1-capt 2-copilot 3-overhead 4-ctr1 5-ctr2, 6-left side, 7-right side, 8-11 - pax1-4	local a = get(swview)
	local a = get(swview)
	if a ~= a_last then
		if a == 1 then set(px, -0.487680) set(py, 0.542344) set(pz, -7.880973) set(az, 0) set(ax, 0) set(swview, 0) --
		elseif a == 2 then set(px, 0.487680) set(py, 0.542344) set(pz, -7.880973) set(az, 0) set(ax, 0) set(swview, 0) --
		elseif a == 3 then set(px, 0) set(py, 0.542344) set(pz, -7.880973) set(az, 50) set(ax, 0) set(swview, 0) --
		elseif a == 4 then set(px, 0) set(py, 0.786954) set(pz, -8.41) set(az, -74) set(ax, 0) set(swview, 0) --
		elseif a == 5 then set(px, 0) set(py, 0.462303) set(pz, -7.86) set(az, -37) set(ax, 0) set(swview, 0) --
		elseif a == 6 then set(px, -0.441119) set(py, 0.860357) set(pz, -8.24) set(az, -54) set(ax, 270) set(swview, 0) --
		elseif a == 7 then set(px, 0.411119) set(py, 0.852841) set(pz, -8.25) set(az, -43) set(ax, 90) set(swview, 0) --
		elseif a == 8 then set(px, -0.632988) set(py, 0.561920) set(pz, -1.7405) set(az, -1.5) set(ax, 271) set(swview, 0) --
		elseif a == 9 then set(px, 0.632988) set(py, 0.561920) set(pz, -1.7405) set(az, -4.5) set(ax, 86) set(swview, 0) --
		elseif a == 10 then set(px, -0.349878) set(py, 0.454699) set(pz, 0.152532) set(az, 0) set(ax, 0) set(swview, 0) --
		elseif a == 11 then set(px, -0.343429) set(py, 0.464306) set(pz, -5.39518) set(az, 4.16) set(ax, 175) set(swview, 0)
		end
	end
	a_last = 0
--[[
