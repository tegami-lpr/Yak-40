...
components = {
    ...
    switch {
        ...
        state = function()
	    return get(globalPropertyi("yak40/panels/payload/visible")) ~= 0
            --return get(payload) ~= 0
        end,
        --btnOn = get(tmb_up),
        --btnOff = get(tmb_dn),
        onMouseClick = function()
	    commandOnce(findCommand("yak40/Toggle_Payload_Panel"))
	    return true	
	end
--[[
        onMouseClick = function()
...
--]]
    ...
    switch {
        ...
        onMouseClick = function()
            commandOnce(findCommand("yak40/Toggle_GPS_Panel"))
            return true;
        end 
    },
