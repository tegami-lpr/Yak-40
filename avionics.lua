print("it's Yak-40 by Felis modified by 1941, P.Pranov, R.Guseynov, O.Tronov, N.Parshukov, M.Zuev version 2.6 and then modifyed by Valery Rulyov to version 3.2")
size = { 2048, 2048 }
...
createProp("sim/custom/updateyak/fuel/fuel_press_0", "float", 0);
createProp("sim/custom/updateyak/fuel/fuel_press_1", "float", 0);
createProp("sim/custom/updateyak/fuel/fuel_press_2", "float", 0);
...
--	},
	...
	emi3 {
		...
		fuel_p = globalPropertyf("sim/custom/updateyak/fuel/fuel_press_1"),
	...
	emi3 {
		...
		fuel_p = globalPropertyf("sim/custom/updateyak/fuel/fuel_press_0"),
	...
	emi3 {
		...
		fuel_p = globalPropertyf("sim/custom/updateyak/fuel/fuel_press_2"),
