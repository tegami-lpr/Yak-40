...
createGlobalPropertys("kln90b/KLN90/graphNAV5Comp", " ");
createGlobalPropertys("kln90b/KLN90/graphAPT3Comp", " ");
-- Serialized string datarefs for text --
createGlobalPropertys("kln90b/KLN90/gline_1", "WAIT FOR MASTER");
createGlobalPropertys("kln90b/KLN90/gline_2", "WAIT FOR MASTER");
createGlobalPropertys("kln90b/KLN90/gline_3", "WAIT FOR MASTER");
createGlobalPropertys("kln90b/KLN90/gline_4", "WAIT FOR MASTER");
createGlobalPropertys("kln90b/KLN90/gline_5", "WAIT FOR MASTER");
createGlobalPropertys("kln90b/KLN90/gline_6", "WAIT FOR MASTER");
createGlobalPropertys("kln90b/KLN90/gline_7", "WAIT FOR MASTER");
createGlobalPropertys("kln90b/KLN90/gline_8", "WAIT FOR MASTER");
createGlobalPropertys("kln90b/KLN90/bline_1", "WAIT FOR MASTER");
createGlobalPropertys("kln90b/KLN90/bline_2", "WAIT FOR MASTER");
createGlobalPropertys("kln90b/KLN90/bline_3", "WAIT FOR MASTER");
createGlobalPropertys("kln90b/KLN90/bline_4", "WAIT FOR MASTER");
createGlobalPropertys("kln90b/KLN90/bline_5", "WAIT FOR MASTER");
createGlobalPropertys("kln90b/KLN90/bline_6", "WAIT FOR MASTER");
createGlobalPropertys("kln90b/KLN90/bline_7", "WAIT FOR MASTER");
createGlobalPropertys("kln90b/KLN90/bline_8", "WAIT FOR MASTER");
createGlobalPropertys("kln90b/KLN90/scale_line", " ");
createGlobalPropertyi("kln90b/KLN90/cage", 0);
local cagevisible = createGlobalPropertyi("kln90b/KLN90/cage_visible", 0);

-- Aircraft power bus
createGlobalPropertyi("kln90b/kln_power", 0);
defineProperty("kln_power", globalPropertyi("kln90b/kln_power"));

-- Animation datarefs for 3D model --
createGlobalPropertyi("kln90b/KLN90/3D_L_Angle", 1);
createGlobalPropertyi("kln90b/KLN90/3D_R_Angle", 1);

--defineProperty("SC_master", globalPropertyi("scp/api/ismaster")) -- status of SmartCopilot (0 = no connection, 1 = slave, 2 = master)
SC_master = createProperty(2)
	

-- Graph serialized string to show flightplan path
defineProperty("sc_graphNAV5Comp", globalPropertys("kln90b/KLN90/graphNAV5Comp"))
defineProperty("sc_graphAPT3Comp", globalPropertys("kln90b/KLN90/graphAPT3Comp"))
-- Text strings for SmartCopilot sync
defineProperty("sc_gline_1", globalPropertys("kln90b/KLN90/gline_1"))
defineProperty("sc_gline_2", globalPropertys("kln90b/KLN90/gline_2"))
defineProperty("sc_gline_3", globalPropertys("kln90b/KLN90/gline_3"))
defineProperty("sc_gline_4", globalPropertys("kln90b/KLN90/gline_4"))
defineProperty("sc_gline_5", globalPropertys("kln90b/KLN90/gline_5"))
defineProperty("sc_gline_6", globalPropertys("kln90b/KLN90/gline_6"))
defineProperty("sc_gline_7", globalPropertys("kln90b/KLN90/gline_7"))
defineProperty("sc_gline_8", globalPropertys("kln90b/KLN90/gline_8"))
defineProperty("sc_bline_1", globalPropertys("kln90b/KLN90/bline_1"))
defineProperty("sc_bline_2", globalPropertys("kln90b/KLN90/bline_2"))
defineProperty("sc_bline_3", globalPropertys("kln90b/KLN90/bline_3"))
defineProperty("sc_bline_4", globalPropertys("kln90b/KLN90/bline_4"))
defineProperty("sc_bline_5", globalPropertys("kln90b/KLN90/bline_5"))
defineProperty("sc_bline_6", globalPropertys("kln90b/KLN90/bline_6"))
defineProperty("sc_bline_7", globalPropertys("kln90b/KLN90/bline_7"))
defineProperty("sc_bline_8", globalPropertys("kln90b/KLN90/bline_8"))
defineProperty("sc_scaleline", globalPropertys("kln90b/KLN90/scale_line"))
defineProperty("sc_cage", globalPropertyi("kln90b/KLN90/cage"))
-- animation
defineProperty("L_Angle_3D", globalPropertyi("kln90b/KLN90/3D_L_Angle"))
defineProperty("R_Angle_3D", globalPropertyi("kln90b/KLN90/3D_R_Angle"))

------------------------------------------------------------------------------------
------------------------------------------------------------------------------------

--defineProperty("bg", loadImage("KLN90.png", 0, 0, 914, 293))
defineProperty("bg", loadImage("KLN90.png", 0, 219, 914, 293))
--defineProperty("glass", loadImage("KLN90.png", 10, 298, 426, 199))
defineProperty("glass", loadImage("KLN90.png", 10, 15, 426, 199))
...
defineProperty("mapplane", loadImage("KLNmap.png", 2, 58, 5, 4))
defineProperty("mapstar", loadImage("KLNmap.png", 16, 57, 5, 5))
defineProperty("mapdiamond", loadImage("KLNmap.png", 9, 57, 5, 5))
defineProperty("mappixel", loadImage("KLNmap.png", 4, 53, 1, 1))
defineProperty("mapplus", loadImage("KLNmap.png", 43, 58, 3, 3))

----defineProperty("mappixel", loadImage("KLNmap.png", 4, 11, 2, 2))

defineProperty("mapquad", loadImage("KLNmap.png", 9, 52, 3, 3))
defineProperty("mapAPT", loadImage("KLNmap.png", 23, 57, 5, 5))
defineProperty("mapNDB", loadImage("KLNmap.png", 30, 57, 4, 4))
defineProperty("mapVOR", loadImage("KLNmap.png", 36, 57, 5, 5))

defineProperty("Atex", loadImage("KLNmap.png", 1,   21, 5, 7))
defineProperty("Btex", loadImage("KLNmap.png", 7,   21, 5, 7))
defineProperty("Ctex", loadImage("KLNmap.png", 13,  21, 5, 7))
defineProperty("Dtex", loadImage("KLNmap.png", 19,  21, 5, 7))
defineProperty("Etex", loadImage("KLNmap.png", 25,  21, 5, 7))
defineProperty("Ftex", loadImage("KLNmap.png", 31,  21, 5, 7))
defineProperty("Gtex", loadImage("KLNmap.png", 37,  21, 5, 7))
defineProperty("Htex", loadImage("KLNmap.png", 43,  21, 5, 7))
defineProperty("Itex", loadImage("KLNmap.png", 49,  21, 5, 7))
defineProperty("Jtex", loadImage("KLNmap.png", 55,  21, 5, 7))
defineProperty("Ktex", loadImage("KLNmap.png", 61,  21, 5, 7))
defineProperty("Ltex", loadImage("KLNmap.png", 67,  21, 5, 7))
defineProperty("Mtex", loadImage("KLNmap.png", 73,  21, 5, 7))
defineProperty("Ntex", loadImage("KLNmap.png", 79,  21, 5, 7))
defineProperty("Otex", loadImage("KLNmap.png", 85,  21, 5, 7))
defineProperty("Ptex", loadImage("KLNmap.png", 91,  21, 5, 7))
defineProperty("Qtex", loadImage("KLNmap.png", 97,  21, 5, 7))
defineProperty("Rtex", loadImage("KLNmap.png", 103, 21, 5, 7))
defineProperty("Stex", loadImage("KLNmap.png", 109, 21, 5, 7))
defineProperty("Ttex", loadImage("KLNmap.png", 115, 21, 5, 7))
defineProperty("Utex", loadImage("KLNmap.png", 121, 21, 5, 7))
defineProperty("Vtex", loadImage("KLNmap.png", 127, 21, 5, 7))
defineProperty("Wtex", loadImage("KLNmap.png", 133, 21, 5, 7))
defineProperty("Xtex", loadImage("KLNmap.png", 139, 21, 5, 7))
defineProperty("Ytex", loadImage("KLNmap.png", 145, 21, 5, 7))
defineProperty("Ztex", loadImage("KLNmap.png", 151, 21, 5, 7))
defineProperty("ötex", loadImage("KLNmap.png", 157, 21, 5, 7))
defineProperty("ö0tex", loadImage("KLNmap.png", 1,  13, 5, 7))
defineProperty("ö1tex", loadImage("KLNmap.png", 7,  13, 5, 7))
defineProperty("ö2tex", loadImage("KLNmap.png", 13, 13, 5, 7))
defineProperty("ö3tex", loadImage("KLNmap.png", 19, 13, 5, 7))
defineProperty("ö4tex", loadImage("KLNmap.png", 25, 13, 5, 7))
defineProperty("ö5tex", loadImage("KLNmap.png", 31, 13, 5, 7))
defineProperty("ö6tex", loadImage("KLNmap.png", 37, 13, 5, 7))
defineProperty("ö7tex", loadImage("KLNmap.png", 43, 13, 5, 7))
defineProperty("ö8tex", loadImage("KLNmap.png", 49, 13, 5, 7))
defineProperty("ö9tex", loadImage("KLNmap.png", 55, 13, 5, 7))
...
defineProperty("FuelFlow1", globalPropertyfae("sim/flightmodel/engine/ENGN_FF_", 1))
defineProperty("FuelFlow2", globalPropertyfae("sim/flightmodel/engine/ENGN_FF_", 2))
defineProperty("FuelFlow3", globalPropertyfae("sim/flightmodel/engine/ENGN_FF_", 3))
defineProperty("FuelFlow4", globalPropertyfae("sim/flightmodel/engine/ENGN_FF_", 4))
defineProperty("FuelFlow5", globalPropertyfae("sim/flightmodel/engine/ENGN_FF_", 5))
defineProperty("FuelFlow6", globalPropertyfae("sim/flightmodel/engine/ENGN_FF_", 6))
defineProperty("FuelFlow7", globalPropertyfae("sim/flightmodel/engine/ENGN_FF_", 7))
defineProperty("FuelFlow8", globalPropertyfae("sim/flightmodel/engine/ENGN_FF_", 8))
defineProperty("FuelTOT", globalPropertyf("sim/flightmodel/weight/m_fuel_total"))
defineProperty("MD41test", globalPropertyi("kln90b/MD41/test"))
...
defineProperty("GPSmode", globalPropertyi("kln90b/KLN90/OBS"))
defineProperty("OBSreq", globalPropertyi("kln90b/MD41/OBSreq"))
defineProperty("APR", globalPropertyi("kln90b/KLN90/APR"))

defineProperty("WPTalert", globalPropertyi("kln90b/KLN90/WPT"))
defineProperty("MSGalert", globalPropertyi("kln90b/KLN90/MSG"))
defineProperty("Flash", globalPropertyi("kln90b/KLN90/Flash"))
...
defineProperty("KLN90visible", globalPropertyi("kln90b/KLN90/visible"))
defineProperty("popx", globalPropertyi("kln90b/KLN90pop/x"))
defineProperty("popy", globalPropertyi("kln90b/KLN90pop/y"))

--check kln power
--defineProperty("kln_powerr", globalPropertyi("kln90b/kln_power"));
...
local displayBrightness = createGlobalPropertyf("kln90b/KLN90/brightness", 0.8)
	...
	if values["primary"] == 1 then
		...
		while num <= FPlan[0]["length"] do
			if FPlan[0][num]["types"] == 4 or FPlan[0][num]["types"] == 5 or FPlan[0][num]["USR"] == 1 then
				...
				local num2 = 1
				while num2 <= 6 do
					local chr = string.sub(lat, num2, num2)
					if chr == " " then
						break
					end
					local cmdName = "sim/FMS/key_" .. string.sub(lat, num2, num2)
					if chr == "." then
						cmdName = "sim/FMS/key_period"
					end
					commandOnce(findCommand(cmdName))
					num2 = num2 + 1
				end
				...
				num2 = 1
				while num2 <= 7 do
					local chr = string.sub(lon, num2, num2)
					if chr == " " then
						break
					end
					local cmdName = "sim/FMS/key_" .. string.sub(lon, num2, num2)
					if chr == "." then
						cmdName = "sim/FMS/key_period"
					end
					commandOnce(findCommand(cmdName))
				...
				local num2 = 1
				while num2 <= 5 do
					local chr = string.sub(FPlan[0][num]["ident"], num2, num2)
					if chr == " " then
						break
					end
	...
	if math.abs(x1-x2) > math.abs(y1-y2) then
		...
		while x3 < x4 do
			if x3-0.5 > size[1] and x3+0.5 < size[1]+size[3] and y3-0.5 > size[2] and y3+0.5 < size[2]+size[4] then
				table.insert(tables, textureLit {
						...
						if values["VORnearestlist"][num]["range"] > VORrange then
							...
							if dist1 < 90 then
								...
								if x1-2.5 > size[1] and x1+2.5 < size[1]+size[3] and y1-2.5 > size[2] and y1+2.5 < size[2]+size[4] then
									table.insert(Nav5Comp, textureLit {
								...
								table.insert ( Nav5Comp_Serializer, WrapTextLit(round(x1-2.5),round(y1-2.5),5,5,0,get(displayBrightness),1) )
			...
			while num <=9 do
				...
				if show == 1 then
					...
					if dist1 < 90 then
						...
						table.insert ( Nav5Comp_Serializer, WrapTextLit(round(x1-2),round(y1-2),4,4,6,get(displayBrightness),1) )
		...
		while num <=9 do
			...
			if show == 1 then
				...
				if dist1 < 90 then
					...
					table.insert ( Nav5Comp_Serializer, WrapTextLit(round(x1-2.5),round(y1-2.5),5,5,5,get(displayBrightness),1) )
...
if values["activeWPT"]["active"] == 0 and values["activeWPT"]["length"] == 2 then
	...
	table.insert ( Nav5Comp_Serializer, WrapTextLit(round(x1-2.5),round(y1-2.5),5,5,4,get(displayBrightness),1) )
	if mode == 1 then
...
while WPTnum <= FPlan[0]["length"] do
	...
	table.insert ( Nav5Comp_Serializer, WrapTextLit(round(x1-1.5),round(y1-1.5),3,5,1,get(displayBrightness),1) )
	if mode == 1 then
...
WPTnum = WPTnum + 1
	...
	table.insert ( Nav5Comp_Serializer, WrapTextLit(round(cx-2.5),round(cy-2.5),5,5,3,get(displayBrightness),1) )
else
...
table.insert ( Nav5Comp_Serializer, WrapTextLit(round(cx-2.5),round(cy-2),5,4,2,get(displayBrightness),1) )
		...
		elseif controls[ent] == 1 and (subpage == 70 or subpage == 71 or subpage == 80) then
			...
			if types == 0 then
				if values["SIDSTAR"]["ident"] ~= waypoint[1]["ident"] then
					...
					while run <= 3 do
						local name = "SID"
						local filename = "KLN 90B Navdata/Sids/" .. string.lower(string.sub(waypoint[1]["ident"], 1, 4)) .. ".sid"
						if run == 2 then
							filename = "KLN 90B Navdata/Stars/" .. string.lower(string.sub(waypoint[1]["ident"], 1, 4)) .. ".star"
							name = "STAR"
						elseif run == 3 then
							filename = "KLN 90B Navdata/Stars/" .. string.lower(string.sub(waypoint[1]["ident"], 1, 4)) .. ".app"
							name = "APP"
						end
						local file = io.open(filename, "r")
						if file then
						...
						filename = "KLN 90B Navdata/Sids/" .. string.lower(string.sub(waypoint[1]["ident"], 1, 4)) .. ".sidtrs"
						if run == 2 then
							filename = "KLN 90B Navdata/Stars/" .. string.lower(string.sub(waypoint[1]["ident"], 1, 4)) .. ".startrs"
						elseif run == 3 then
							filename = "KLN 90B Navdata/Stars/" .. string.lower(string.sub(waypoint[1]["ident"], 1, 4)) .. ".apptrs"
						end
						file = io.open(filename, "r")
						if file then
							while true do
					...
					function update()
						...
						elseif lpage == 6 then
							...
							elseif lsubpage[6] == 40 then
								...
								table.insert ( Nav5Comp_Serializer, WrapTextLit(round(values["PONG"]["x"]-1.5),round(values["PONG"]["y"]-1.5),3,3,1,get(displayBrightness),1) )
					...
					if not (lpage == 7 and lsubpage[7] < 10) and not (lpage == 6 and lsubpage[6] == 40 and controls["lCRSR"]  == 1)	then
						...
						elseif rpage == 2 then
							...
							elseif controls["DCT"] >= 1 then
								...
								--limit brighness
								if get(displayBrightness) < 0.1 then
									set(displayBrightness, 0.1)
								elseif get(displayBrightness) > 1 then
									set(displayBrightness, 1)
								end
								...
								if get(SC_master) == 1 then
									...
									for ie,ve in ipairs(draw_elements) do
										local elm = split(ve, ";")
										if elm[1] == "1" then
											table.insert(APT3Comp, textureLit {
											position = {tonumber(elm[2]), tonumber(elm[3]), tonumber(elm[4]), tonumber(elm[5])},
											image = getImage(elm[6]),
											brt2 = function()
												return get(displayBrightness)
							...
							local KLNpowerc_command = createCommand("xap/KLN90/Toggle_Power_Switch", "KLN90B power switch")
							...
							registerCommandHandler(KLNpowerc_command, 1, KLNpowerc_handler)

							local KLNincbrtc_command = createCommand("xap/KLN90/Increase_Brightness", "Increase KLN90B's display brightness")
							function KLNincbrtc_handler(phase)  -- for all commands phase equals: 0 on press; 1 while holding; 2 on release
								if 0 == phase then
									set(displayBrightness, get(displayBrightness) + 0.1)
								end
								return 1
							end
							registerCommandHandler(KLNincbrtc_command, 0, KLNincbrtc_handler)

							local KLNdecbrtc_command = createCommand("xap/KLN90/Decrease_Brightness", "Decrease KLN90B's display brightness")
							...
							local KLNLCRSRc_command = createCommand("xap/KLN90/Toggle_Left_Cursor", "Toggle KLN90B's Left Cursor")
							...
							local KLNRCRSRc_command = createCommand("xap/KLN90/Toggle_Right_Cursor", "Toggle KLN90B's Right Cursor")
							...
							local KLNSCANc_command = createCommand("xap/KLN90/Toggle_Scan_Mode", "Toggle KLN90B's Scan Mode")
							...
							local KLNlknoblccc_command = createCommand("xap/KLN90/Turn_Left_Large_Knob_Counterclockwise", "Turn KLN90B's Left Large Knob Counterclockwise")
							...
							local KLNlknobsccc_command = createCommand("xap/KLN90/Turn_Left_Small_Knob_Counterclockwise", "Turn KLN90B's Left Small Knob Counterclockwise")
							...
							local KLNlknobscc_command = createCommand("xap/KLN90/Turn_Left_Small_Knob_Clockwise", "Turn KLN90B's Left Small Knob Clockwise")
							...
							local KLNlknoblcc_command = createCommand("xap/KLN90/Turn_Left_Large_Knob_Clockwise", "Turn KLN90B's Left Large Knob Clockwise")
							...
							local KLNMSGc_command = createCommand("xap/KLN90/Toggle_Message_Page", "Press KLN90B's MSG Button")
							...
							local KLNALTc_command = createCommand("xap/KLN90/Toggle_Altitude_Page", "Press KLN90B's ALT Button")
							...
							local KLNDTOc_command = createCommand("xap/KLN90/Toggle_Direct_To_Page", "Press KLN90B's DTO Button")
							...
							local KLNCLRc_command = createCommand("xap/KLN90/Press_CLR", "Press KLN90B's CLR Button")
							...
							local KLNENTc_command = createCommand("xap/KLN90/Press_ENT", "Press KLN90B's ENT Button")
							...
							local KLNrknoblccc_command = createCommand("xap/KLN90/Turn_Right_Large_Knob_Counterclockwise", "Turn KLN90B's Right Large Knob Counterclockwise")
							...
							local KLNrknobsccc_command = createCommand("xap/KLN90/Turn_Right_Small_Knob_Counterclockwise", "Turn KLN90B's Right Small Knob Counterclockwise")
							...
							local KLNrknobscc_command = createCommand("xap/KLN90/Turn_Right_Small_Knob_Clockwise", "Turn KLN90B's Right Small Knob Clockwise")
							...
							local KLNrknoblcc_command = createCommand("xap/KLN90/Turn_Right_Large_Knob_Clockwise", "Turn KLN90B's Right Large Knob Clockwise")
...
function draw()
	...
	if get(SC_master) == 1 then
		-- draw if SmartCoPilot enabled and in slave mode

		drawAll(Nav5Comp)
		drawAll(APT3Comp)

		drawBitmapText(font, 125, 98,  get(sc_gline_1), TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(font, 125, 87,  get(sc_gline_2), TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(font, 125, 76,  get(sc_gline_3), TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(font, 125, 65,  get(sc_gline_4), TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(font, 125, 54,  get(sc_gline_5), TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(font, 125, 43,  get(sc_gline_6), TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(font, 125, 29,  get(sc_gline_7), TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(fontb, 125, 98, get(sc_bline_1), TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(fontb, 125, 87, get(sc_bline_2), TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(fontb, 125, 76, get(sc_bline_3), TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(fontb, 125, 65, get(sc_bline_4), TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(fontb, 125, 54, get(sc_bline_5), TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(fontb, 125, 43, get(sc_bline_6), TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(fontb, 125, 29, get(sc_bline_7), TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(fontl, 129.5, 87, get(sc_scaleline), TEXT_ALIGN_LEFT, {brt, brt, brt})
	else
		--default, standalone draw
		drawBitmapText(font, 125, 98, gline[1], TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(font, 125, 87, gline[2], TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(font, 125, 76, gline[3], TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(font, 125, 65, gline[4], TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(font, 125, 54, gline[5], TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(font, 125, 43, gline[6], TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(font, 125, 29, gline[7], TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(fontb, 125, 98, bline[1], TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(fontb, 125, 87, bline[2], TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(fontb, 125, 76, bline[3], TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(fontb, 125, 65, bline[4], TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(fontb, 125, 54, bline[5], TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(fontb, 125, 43, bline[6], TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(fontb, 125, 29, bline[7], TEXT_ALIGN_LEFT, {brt, brt, brt})
		drawBitmapText(fontl, 129.5, 87, values["scaleline"], TEXT_ALIGN_LEFT, {brt, brt, brt})		
	end
	drawAll(Nav5Comp)
	drawAll(APT3Comp)

	drawAll(glassComponent)
end
